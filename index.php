...
<body>
    ...
    <div class="table-responsive">
        <h2 align="center" style="margin-top: 25px;">Menampilkan Data dari Database ke Tabel dengan Datatables PHP</h2>
        <br>
        <table id="data" class="table table-striped table-bordered" style="width:85%; margin-left: 7%">
            <thead>
                <tr>
                    <td>No</td>
                    <td>Nama Siswa</td>
            ...
            <tbody>
                ...
                ?>
                    ...
                    <tr>
                        ...
                        <td><?php echo $jkl ?></td>
                        <td><?php echo $tgl ?></td>
                        <td><button style="font-size: 11px; margin-left: 10%;" class="btn btn-primary" id="detail" name="detail" title="Lihat Detail"><i class="fa fa-search">Detail</i></button></td>
                    </tr>
                <?php } ?>
            </tbody>
        </table>
